...
if (is.null(git_config$user.name) || is.null(git_config$user.email)) {
  ...
  warning(workflowr:::wrap(
    ...
    output: https://jdblischak.github.io/workflowrBeta/"))
}
rm(git_config)
...
if (dir.exists(home_git)) {
  ...
  warning(workflowr:::wrap(
    ...
    the output: https://jdblischak.github.io/workflowrBeta/ \n\nYou should
...
in the [README](https://jdblischak.github.io/workflowrBeta/index.html).
